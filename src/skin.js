...
const OMITRON_CSS = {
  ...
  '--bg-grad-1': '#000000',
  '--bg-grad-2': '#020a02',
  '--panel-bg': 'rgba(0,40,0,0.5)',
  '--panel-border': 'rgba(57,255,20,0.18)',
  '--accent': '#39ff14',
  '--accent-alt': '#22bb0e',
  '--accent-glow': 'rgba(57,255,20,0.45)',
  '--accent-subtle': 'rgba(57,255,20,0.08)',
  '--accent-subtle-drag': 'rgba(57,255,20,0.18)',
  '--text': '#39ff14',
  '--text-muted': '#1c6010',
  '--text-secondary': '#24cc10',
  '--font-ui': "'VT323', 'Courier New', monospace",
  '--font-mono': "'VT323', 'Courier New', monospace",
  '--debug-bg': 'rgba(0,0,0,0.96)',
  '--debug-border': '#0a2008',
  '--upload-audio': '#39ff14',
  '--upload-svg': '#ff6600',
  '--upload-svg-bg': 'rgba(255,100,0,0.05)',
  '--status-success': '#39ff14',
  '--status-error': '#ff4444',
  '--status-info': '#ff9900',
  '--section-border-left': '#39ff14',
};
...
const OMITRON_CANVAS = {
  ...
  disc: {
    ...
    rim: '#001800',
    outerRim: 'rgba(57,255,20,0.07)',
    rings: ['rgba(57,255,20,0.018)', 'rgba(0,80,0,0.012)'],
  },
  label: {
    bg: ['#001a00', '#000e00', '#000800'],
    border: '#004a00',
    innerRing: 'rgba(57,255,20,0.38)',
    text: 'rgba(57,255,20,0.88)',
    textEmpty: 'rgba(57,255,20,0.3)',
  },
  groove: {
    base: 'rgba(57,255,20,0.22)',
    glow: '#39ff14',
    glowCore: 'rgba(57,255,20,0.10)',
    hueShift: 0,
    hueMult: 1.0,
  },
  activeRing: {
    outer: 'rgba(57,255,20,0.26)',
    inner: 'rgba(100,255,50,0.12)',
    glow: '#39ff14',
  },
  stylus: {
    bloom: '#39ff14',

...
class GrooveCodec {
  ...
  loadGrooveFromText(svgText, nameHint) {
    ...
    document.getElementById('saveGrooveBtn').disabled = false;

    this.setStatus(`Visual groove loaded${nameHint ? ': ' + nameHint : ''}`, 'success');
